...
export const development = gulp.series(
	'clean',
	gulp.parallel(['views', 'svg_css', 'styles', 'scripts', 'images', 'webp', 'sprites', 'favicons', 'fonts']),
	gulp.parallel('serve')
);

export const prod = gulp.series('clean', gulp.parallel(['views', 'styles', 'scripts', 'images', 'webp', 'sprites', 'fonts', 'gzip']));
